...
class CreateFormSubjectAreaOptionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_subject_area_option', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::table('form_subject_area_option', function (Blueprint $table) {
            //
        });
    }
}
