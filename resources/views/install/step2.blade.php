          ...
          <div class="card-header">
            ...
            <form autocomplete="off" action="{{ route('store.step2') }}" id="step2form" method="POST" class="database-validation" novalidate>
              ...
              <div class="col-md-6 mb-3">
                   ...
                   <input name="DB_HOST" type="text" class="form-control" id="DB_HOST" placeholder="localhost" value="{{ config('database.connections.mysql.host') }}" required>
              ...
              <div class="col-md-6 mb-3">
                   ...
                   <input name="DB_PORT" type="text" class="form-control" id="DB_PORT" placeholder="3306" value="{{ config('database.connections.mysql.port') }}" required>
              ...
              <div class="col-md-6 mb-3">
                   ...
                   <input name="DB_DATABASE" type="text" class="form-control" id="DB_DATABASE" placeholder="db_name" value="{{ config('database.connections.mysql.database') }}" required>
              ...
              <div class="col-md-6 mb-3">
                   ...
                   <input name="DB_USERNAME" type="text" class="form-control" id="DB_USERNAME" placeholder="root" value="{{ config('database.connections.mysql.username') }}" required>
              ...
              <div class="eyeCy col-md-6 mb-3">
                   ...
                   <input name="DB_PASSWORD" type="password" class="form-control" id="validationCustom05" placeholder="*****" value="{{ config('database.connections.mysql.password') }}">
