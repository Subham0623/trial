...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('plugins/pdfjs-flipbook/web/viewer.css')}}" />
    <!-- magazine.css -->
    <link rel="stylesheet" href="{{ asset('plugins/pdfjs-flipbook/web/magazine.css')}}" />
...
<body tabindex="1" class="loadingInProgress">
            ...
            <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
                <div id="secondaryToolbarButtonContainer">
                    <button id="secondaryPresentationMode"
                        ...
                        title="Switch to Presentation Mode" tabindex="52" data-l10n-id="presentation_mode">
                    ...
                    <span id="secondaryDownload" class="secondaryToolbarButton download visibleMediumView"
                ...
                <div id="toolbarContainer">
                    <div id="toolbarViewer">
                        ...
                        <div id="toolbarViewerRight">
                            ...
                            <span id="download" class="toolbarButton download d-none hiddenMediumView" title="Download"
    ...
    <script>
            var encryptStr = '{{$encrypted}}';
            var key = '{{$key}}';
            var url = '{{config("app.url")}}';
    </script>
    <script src="{{ asset('plugins/pdfjs-flipbook/web/compatibility.js')}}"></script>
    <!-- This snippet is used in production (included from viewer.html) -->
    <link rel="resource" type="application/l10n"
        href="{{ asset('plugins/pdfjs-flipbook/web/locale/locale.properties')}}" />
    <!-- jquery may not necessary in cms -->
    <script src="https://code.jquery.com/jquery-2.1.4.min.js"></script>
    <!-- turn.min.js, zoom.min.js, magazine.js -->
    <script src="{{ asset('plugins/pdfjs-flipbook/web/l10n.js') }}"></script>
    <script src="{{ asset('plugins/pdfjs-flipbook/build/pdf.js') }}"></script>
    <script src="{{ asset('plugins/pdfjs-flipbook/build/pdf.worker.js') }}"></script>
    <script src="{{ asset('plugins/pdfjs-flipbook/turnjs4/lib/turn.min.js') }}"></script>
    <script src="{{ asset('plugins/pdfjs-flipbook/turnjs4/lib/zoom.min.js') }}"></script>
    <script src="{{ asset('plugins/pdfjs-flipbook/web/debugger.js') }}"></script>
    <script src="{{ asset('plugins/pdfjs-flipbook/web/viewer.js') }}"></script>
    <script src="{{ asset('plugins/pdfjs-flipbook/web/magazine.js') }}"></script>
