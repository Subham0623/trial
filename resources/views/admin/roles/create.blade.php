            ...
            <div class="form-group">
                <div class="check__box-design">
                    <div class="check__box-container">
                        <div class="check__box-container-1">
                        <div class="check__all-design">
                            <label for="checkAll-1">Check All</label>
                            <input
                            type="checkbox"
                            class="check__all"
                            id="checkAll-1"
                        ...
                        <div
                            class="child__box-container child__box-container-1"
                            data-checkbox-tab="1"
                        >
                        ...
                        <div class="check__box-container-2">
                        <div class="check__all-design">
                            <label for="checkAll-2">Check All</label>
                            <input
                            type="checkbox"
                            class="check__all"
                            id="checkAll-2"
                            data-checkall-trigger="group2"
                            />
                            <label for="checkAll-2" class="check__all-box">
                            <div class="state unchecked active-state"></div>
                            <div class="state checked">
                                <svg
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div
                            class="child__box-container child__box-container-2"
                            data-checkbox-tab="2"
                        >
                            <div class="child__box">
                            <input
                                type="checkbox"
                                name="cb"
                                id="check__box-container-2-1"
                                data-checkall-group="group2"
                            />
                            <label for="check__box-container-2-1" id="checkbox">
                                <svg viewBox="0 0 100 100">
                                <path
                                    class="box"
                                    d="M82,89H18c-3.87,0-7-3.13-7-7V18c0-3.87,3.13-7,7-7h64c3.87,0,7,3.13,7,7v64C89,85.87,85.87,89,82,89z"
                            ...
                            <input
                                type="checkbox"
                                name="cb"
                                id="check__box-container-2-2"
                                data-checkall-group="group2"
                            />
                            <label for="check__box-container-2-2" id="checkbox">
                                <svg viewBox="0 0 100 100">
                                <path
                                    class="box"
                                    d="M82,89H18c-3.87,0-7-3.13-7-7V18c0-3.87,3.13-7,7-7h64c3.87,0,7,3.13,7,7v64C89,85.87,85.87,89,82,89z"
